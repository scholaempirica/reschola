...
#' \dontrun{
#' library(reschola)
#' manage_docx_header_logos("draft.docx", png_logo_path = "logos/newlogo.png", action = "add_client")
#' manage_docx_header_logos("draft.docx", png_logo_path = "logos/newlogo.png", action = "replace_schola")
#' }
