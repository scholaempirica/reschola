...
It allows you to pull into Rmarkdown any edits, tracked changes and comments that people make *in the resulting Word document*. See below for how to work with it.
...
```
# ```{r, child=c('one.Rmd', 'two.Rmd')} # remove the hash mark
...
For now, you can work the same as with any RMarkdown file.

See below in "Iterate the report" on the steps to make collaboration work.
